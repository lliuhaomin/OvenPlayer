...
/**
    ...
    */
t.default=function(e,t){var n=(0,r.default)(e,a.PROVIDER_DASH),i=n.create(),u="",l={},s="",d="",c=0;try{(u=dashjs.MediaPlayer().create()).getDebug().setLogToBrowserConsole(!1),u.initialize(i,null,!1),l=(0,o.default)(a.PROVIDER_DASH,u,t,function(e,t){OvenPlayerConsole.log("DASH : onBeforeLoad : ",e,"lastPlayPosition : "+t),u.attachSource(e.file),c=t}),OvenPlayerConsole.log("DASH PROVIDER LOADED."),d=l.super("play"),s=l.super("destroy"),l.on(a.CONTENT_META,function(e){u.isDynamic()?d():c&&(u.seek(c),d())},l),l.destroy=function(){u.reset(),n.destroy(),OvenPlayerConsole.log("DASH : PROVIDER DESTROYED."),s()}}catch(e){throw new Error(e)}return l}},
/***/28:
...
/*if(!!document.documentMode == true ){
            ...
            return 'unknown';
        }*/return function(){for(var e=3,t=document.createElement("div"),n=t.getElementsByTagName("i");t.innerHTML="\x3c!--[if gt IE "+ ++e+"]><i></i><![endif]--\x3e",n[0];);return e>4?e:void 0}()<9?"oldIE":"modernIE"}return"unknown"};
/***/},
/***/76:
...
/***/79:
/***/function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var r=l(n(12)),o=l(n(78)),a=l(n(0)),i=l(n(6)),u=n(2);function l(e){return e&&e.__esModule?e:{default:e}}t.default=function(e,t,n,l){OvenPlayerConsole.log("CORE loaded. ");var s={};(0,r.default)(s);var d=function(e,t){return a.default.isElement(t)?t:e===u.PROVIDER_DASH?t.getVideoElement():e===u.PROVIDER_HLS?t.media:null}(e,t),c=(0,o.default)(e,t,d,s),f=!1,E=!1,g=u.STATE_IDLE,v=0,y=-1,T=[],O=n.getConfig().image||"";d.playbackRate=d.defaultPlaybackRate=n.getDefaultPlaybackRate();var m=function(e){var t=Math.max(0,y);if(e)for(var r=0;r<e.length;r++)if(e[r].default&&(t=r),n.getQualityLabel()&&e[r].label===n.getQualityLabel())return r;return t},p=function(e){var t=T[y];if(l)l(t,e);else{OvenPlayerConsole.log("source loaded : ",t,"lastPlayPosition : "+e);var n=d.src,r=document.createElement("source");r.src=t.file,r.src!==n?(d.src=T[y].file,
// Do not call load if src was not set. load() will cancel any active play promise.
n&&d.load()):0==e&&d.currentTime>0&&s.seek(e),e>0&&(s.seek(e),s.play()),s.trigger(u.CONTENT_LEVELS,{currentQuality:y}),O&&(d.poster=O)}};return s.getName=function(){return e},s.canSeek=function(){return f},s.setCanSeek=function(e){f=e},s.isSeeking=function(){return E},s.setSeeking=function(e){E=e},s.setState=function(e){if(g!=e){var t=g;switch(e){case u.STATE_COMPLETE:s.trigger(u.PLAYER_COMPLETE);break;case u.STATE_PAUSED:s.trigger(u.PLAYER_PAUSE,{prevState:g});break;case u.STATE_PLAYING:s.trigger(u.PLAYER_PLAY,{prevState:g})}g=e,s.trigger(u.PLAYER_STATE,{prevstate:t,newstate:g})}},s.getState=function(){return g},s.setBuffer=function(e){v=e},s.getBuffer=function(){return v},s.getDuration=function(){return d.duration==1/0||e===u.PROVIDER_DASH&&t.isDynamic()?1/0:d.duration},s.getPosition=function(){return d.currentTime},s.setVolume=function(e){d.volume=e/100},s.getVolume=function(){return 100*d.volume},s.setMute=function(e){return void 0===e?(d.muted=!d.muted,s.trigger(u.CONTENT_MUTE,{mute:d.muted})):(d.muted=e,s.trigger(u.CONTENT_MUTE,{mute:d.muted})),d.muted},s.getMute=function(){return d.muted},s.preload=function(e,t){return y=m(T=e),p(t||0),new i.default(function(e,t){e()})},s.load=function(e){y=m(T=e),p(e.starttime||0)},s.play=function(){s.getState()!==u.STATE_PLAYING&&d.play()},s.pause=function(){s.getState()==u.STATE_PLAYING&&d.pause()},s.seek=function(e){d.currentTime=e},s.setPlaybackRate=function(e){return s.trigger(u.PLAYBACK_RATE_CHANGED,{playbackRate:e}),d.playbackRate=d.defaultPlaybackRate=e},s.getPlaybackRate=function(){return d.playbackRate},s.getQualityLevels=function(){return T.map(function(e,t){return{file:e.file,type:e.type,label:e.label,index:t}})},s.getCurrentQuality=function(){var e=T[y];return{file:e.file,type:e.type,label:e.label,index:y}},s.setCurrentQuality=function(e,t){return y!=e&&(e>-1&&T&&T.length>e?(
//that.pause();
