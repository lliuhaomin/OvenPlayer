...
//IE8+
return u.clientHeight},n.attr=function(e){return u.getAttribute(e)},n.replace=function(e){u.replaceWith(e)},n.append=function(e){u.appendChild(e)},n.remove=function(){u.remove()},n.removeChild=function(){for(;u.hasChildNodes();)u.removeChild(u.firstChild)},n.get=function(){return u},n.closest=function(e){return u.closest(e)},n):null}},
/* 4 */
 ...
 */
l.getPlayerByContainerId=function(e){for(var t=0;t<c.length;t++)if(c[t].getContainerId()===e)return c[t];return null},
/**
 ...
 * @return     {null}
 */
l.removePlayer=function(e){console.log(e);for(var t=0;t<c.length;t++)c[t].getContainerId()===e&&c.splice(t,1)},
/**
